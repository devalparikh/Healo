...
//       item.employerType === employerType && item.level === level
//     );
//   };
...
//             <h1 className="text-2xl font-bold text-gray-900">Healo</h1>
//             <button
...
//               <h2 className="text-xl font-semibold mb-4">{employerType}</h2>
//               <WorkLifeBalanceBar score={getAverageScore(employerType)} />
//               <div className="space-y-4">
//                 {levels.map(level => {
//                   const data = getData(employerType, level);
//                   return data && (
//                     <SalaryCard
//                       key={level}
//                       level={level}
